                ...
                <div className="flex flex-col gap-3">
                  <div className="rounded-2xl bg-[#f6f6f6] px-5 py-4 md:px-6">
                    ...
                    <p className="mt-2.5 text-[14px] font-normal leading-[1.4] tracking-[-0.56px] text-[#303030]">
                      {feedback?.trim()
                        ? feedback
                        : "No feedback yet. Add teacher notes below and save."}
                    </p>
                  </div>

                  {isSelected && (
                    <div className="space-y-3 rounded-2xl border border-black/5 bg-white p-3">
                      <div className="flex items-center justify-between gap-2">
                        <p className="text-[12px] font-bold text-[#5e5e5e]">
                          Configure Mapping &amp; Feedback
                        </p>
                        <button
                          type="button"
                          onClick={() => {
                          ...
                          className={cn(
                            "inline-flex h-7 cursor-pointer items-center gap-1 rounded-full border px-3 text-[11px] font-extrabold transition-standard",
                            isDrawingMode
                              ? "border-transparent bg-[#ff5623] text-white"
                              : "border-black/10 bg-white text-[#303030] hover:bg-slate-50"
                          )}
                        >
                      ...
                      {isDrawingMode && (
                        <div className="rounded-xl border border-[#ff5623]/25 bg-[#ff5623]/5 p-2.5 text-center text-[11px] font-semibold text-[#ff5623]">
                          Drawing Mode Active: Click and drag on the answer sheet to define
                          the answer box.
                        </div>
                      )}
                      ...
                      <div className="space-y-1">
                        ...
                        <textarea
                          ...
                          className="h-16 w-full resize-none rounded-xl border border-black/10 bg-[#f8f8f8] p-3 text-[12px] font-medium text-[#303030] placeholder:text-[#5e5e5e]/30 focus:outline-none"
                        />
                      </div>
                      ...
                      <div className="grid grid-cols-2 gap-3">
                        <div className="space-y-1">
                          <label className="text-[11px] font-bold text-[#5e5e5e]/85">
                            Score (Max {activeQuestion?.marks || 0})
                          </label>
                          <input
                            type="number"
                            min={0}
                            max={activeQuestion?.marks || 0}
                            value={editedScore}
                            onChange={(e) =>
                              setEditedScore(
                                Math.min(
                                  activeQuestion?.marks || 0,
                        ...
                        <div className="space-y-1">
                          ...
                          <span
                            className={cn(
                              "block rounded-xl border py-2 text-center text-[11px] font-bold uppercase",
                              isUnanswered
                      ...
                      <div className="flex gap-2 border-t border-black/5 pt-3">
                        <button
                          ...
                          className="flex h-10 flex-1 cursor-pointer items-center justify-center gap-1.5 rounded-full border-none bg-[#181818] text-[13px] font-bold text-white transition-standard hover:bg-[#272727] disabled:opacity-50"
                        >
                        ...
                        <button
                          ...
                          className={cn(
                            "flex h-10 flex-1 cursor-pointer items-center justify-center gap-1.5 rounded-full border text-[13px] font-bold transition-standard disabled:opacity-50",
                      ...
                      <button
                        type="button"
                        onClick={() =>
                          router.push(`/exams/${currentExam.id}/report`)
                        }
                        className="inline-flex h-9 w-full cursor-pointer items-center justify-center gap-1.5 rounded-full border border-black/10 bg-white text-[12px] font-extrabold text-[#303030] transition-standard hover:bg-slate-50"
                      >
                        <FileText className="h-4 w-4 text-[#ff5623]" />
