          ...
          <div className="mx-auto w-full max-w-[1100px] px-4 pt-3 pb-24 md:px-0 md:pb-20 flex-1 flex flex-col">
            {isLoading ? (
              ...
              <div className="flex flex-col gap-4">
                ...
                {/* Search Bar */}
                <div className="relative flex items-center bg-white rounded-[24px] border border-black/10 focus-within:border-black/20 px-4 h-[46px] w-full max-w-[360px] no-print transition-all duration-200">
