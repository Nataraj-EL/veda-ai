...
export default function CreateExamPage() {
  ...
  return (
    <div className="flex h-screen bg-page-fill text-neutral-primary font-sans overflow-hidden">
      {/* Sidebar navigation */}
      <Sidebar variant="assignments" assignmentCount={0} primaryCta="aiTeacherToolkit" defaultCollapsed={isUploading} showSettings={!isUploading && !questionPaper && !answerSheet} />
                      ...
                      {!questionPaper ? (
                        ...
                        <div className="flex h-44 flex-col items-center justify-center rounded-[24px] md:rounded-[20px] border border-dashed border-[#c5c5c5] bg-white p-4 text-center">
                          <div className="relative flex w-full max-w-[280px] items-center gap-4.5 rounded-[12px] bg-[#f4f4f6] px-4 py-3 text-left">
                            ...
                            <svg width="34" height="44" viewBox="0 0 34 44" fill="none" xmlns="http://www.w3.org/2000/svg" className="shrink-0">
                              <path d="M4 0C1.79086 0 0 1.79086 0 4V40C0 42.2091 1.79086 44 4 44H30C32.2091 44 34 42.2091 34 40V13.5C34 13.5 27.5 13.5 20.5 0H4Z" fill="#E55353" />
                              <path d="M20.5 0V9.5C20.5 11.7 22.3 13.5 24.5 13.5H34C27.5 13.5 20.5 6.5 20.5 0Z" fill="#F27777" />
                              <text x="17" y="29" fill="white" fontSize="10" fontWeight="900" fontFamily="system-ui, -apple-system, sans-serif" textAnchor="middle" letterSpacing="-0.2">PDF</text>
                            </svg>
